...
package ecl.ho.keysocalbum.database
...
@Database(entities = [AlbumCollectionVo::class], version = 1, exportSchema = false)
abstract class AlbumDatabase : RoomDatabase() {

    /**
     * Connects the database to the DAO.
     */
    abstract val albumCollectionDao: AlbumCollectionDao
